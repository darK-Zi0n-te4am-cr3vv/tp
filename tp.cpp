...
BEGIN_MESSAGE_MAP(CtpApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CtpApp::OnAppAbout)
...
CtpApp::CtpApp()
{
	...
	SetAppID(_T("tp.AppID.NoVersion"));
...
BOOL CtpApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CtpDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CtpView));
	if (!pDocTemplate)
		return FALSE;
